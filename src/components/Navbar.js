...
// propTypes are used such that you dont give a wrong format input
// isRequired shows that title and aboutText should be present
Navbar.propTypes = {
    title : PropTypes.string.isRequired,
    aboutText: PropTypes.string.isRequired
}

// defaultProp to shows values if nothing is specified
Navbar.defaultProps = {
